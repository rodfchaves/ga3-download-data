...
def main():
  ...
  get_report(analytics, reportRequestSeven, 7, FILENAME)
  get_report(analytics, reportRequestEight, 8, FILENAME)
  get_report(analytics, reportRequestNine, 9, FILENAME)
  get_report(analytics, reportRequestTen, 10, FILENAME)
  get_report(analytics, reportRequestEleven, 11, FILENAME)
